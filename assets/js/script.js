...
const contenedorAlgui = document.getElementById("contenedorCardAlqui")

const primerosTres = propiedades_venta.slice(0,3)
const primerosTresAlqui = propiedades_alquiler.slice(0,3)

for (const propiedad_venta of primerosTres) {
...
for (const propiedadEnVenta of primerosTresAlqui) {
  contenedorAlgui.innerHTML += `
    <div class="col-md-4 mb-4">
      <div class="card">
             <img
                src="${propiedadEnVenta.src}"
                class="card-img-top"
                alt="Imagen del departamento"
              />
              <div class="card-body">
                ...
                <p class="card-text">
                  ${propiedadEnVenta.descripcion}
                </p>
                <p>
                  <i class="fas fa-map-marker-alt"></i> ${
                    propiedadEnVenta.ubicacion
                  }
                </p>
                <p>
                  <i class="fas fa-bed"></i> ${
                    propiedadEnVenta.habitaciones
                  } Habitaciones |
                  <i class="fas fa-bath"></i> ${propiedadEnVenta.baños} Baños
                </p>
                <p><i class="fas fa-dollar-sign"></i> ${
                  propiedadEnVenta.costo
                }</p>
                <p class="text-danger">
                  <i class="fas ${propiedadEnVenta.smoke ? "fa-smoking" : "fa-smoking-ban"}"></i> ${propiedadEnVenta.smoke ? "Si se permite fumar" : "No se permite fumar"} 
                </p>
                <p class="text-danger">
                  <i class="fa-solid ${propiedadEnVenta.pets ? "fa-paw" : "fa-ban"}"></i> ${
                    propiedadEnVenta.pets
                      ? "Si, se permiten mascotas"
                      : "Prohibido ingreso con mascotas"
                  }
                </p>
